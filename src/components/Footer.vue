<template>
  ...
  <footer class="footer">
    <div class="content">
      ...
      <ul>
        ...
        >
          <a
            ...
            target="_blank"
            rel="noopener"
          >{{link.title}} <span class="tag is-primary">{{link.version}}</span></a>
        </li>
      </ul>
      ...
      <p>Lyne Design System is <span class="tag is-primary">🧪 experimental</span> at the moment — with enthusiasm. Do not use the project until it has left infancy.</p>
    </div>
  </footer>
